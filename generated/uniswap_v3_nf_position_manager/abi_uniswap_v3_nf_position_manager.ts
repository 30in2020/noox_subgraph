...
export class abi_uniswap_v3_nf_position_manager__positionsResult {
  value0: BigInt;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class abi_uniswap_v3_nf_position_manager extends ethereum.SmartContract {
  static bind(address: Address): abi_uniswap_v3_nf_position_manager {
    return new abi_uniswap_v3_nf_position_manager(
      "abi_uniswap_v3_nf_position_manager",
      address
    );
  }
  ...
  positions(
    tokenId: BigInt
  ): abi_uniswap_v3_nf_position_manager__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new abi_uniswap_v3_nf_position_manager__positionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_positions(
    tokenId: BigInt
  ): ethereum.CallResult<abi_uniswap_v3_nf_position_manager__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(uint256):(uint96,address,address,address,uint24,int24,int24,uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_nf_position_manager__positionsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toAddress(),
