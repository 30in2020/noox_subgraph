...
export class abi_uniswap_v2_factory extends ethereum.SmartContract {
  static bind(address: Address): abi_uniswap_v2_factory {
    return new abi_uniswap_v2_factory("abi_uniswap_v2_factory", address);
  }
