...
export class abi_uniswap_v2_pair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v2_pair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class abi_uniswap_v2_pair extends ethereum.SmartContract {
  static bind(address: Address): abi_uniswap_v2_pair {
    return new abi_uniswap_v2_pair("abi_uniswap_v2_pair", address);
  }
  ...
  burn(to: Address): abi_uniswap_v2_pair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new abi_uniswap_v2_pair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<abi_uniswap_v2_pair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v2_pair__burnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getReserves(): abi_uniswap_v2_pair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new abi_uniswap_v2_pair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<
    abi_uniswap_v2_pair__getReservesResult
  > {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v2_pair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
