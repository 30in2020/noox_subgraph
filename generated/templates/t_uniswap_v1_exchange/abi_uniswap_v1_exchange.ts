...
export class abi_uniswap_v1_exchange__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v1_exchange extends ethereum.SmartContract {
  static bind(address: Address): abi_uniswap_v1_exchange {
    return new abi_uniswap_v1_exchange("abi_uniswap_v1_exchange", address);
  }
  ...
  removeLiquidity(
    ...
    min_tokens: BigInt,
    deadline: BigInt
  ): abi_uniswap_v1_exchange__removeLiquidityResult {
    ...
    return new abi_uniswap_v1_exchange__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    min_tokens: BigInt,
    deadline: BigInt
  ): ethereum.CallResult<abi_uniswap_v1_exchange__removeLiquidityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v1_exchange__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
