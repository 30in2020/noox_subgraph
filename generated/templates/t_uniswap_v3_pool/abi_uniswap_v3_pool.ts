...
export class abi_uniswap_v3_pool__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v3_pool__collectResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v3_pool__collectProtocolResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v3_pool__mintResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v3_pool__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class abi_uniswap_v3_pool__observeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class abi_uniswap_v3_pool__positionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class abi_uniswap_v3_pool__protocolFeesResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v3_pool__slot0Result {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class abi_uniswap_v3_pool__snapshotCumulativesInsideResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class abi_uniswap_v3_pool__swapResult {
  value0: BigInt;
  value1: BigInt;
...
export class abi_uniswap_v3_pool__ticksResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class abi_uniswap_v3_pool extends ethereum.SmartContract {
  static bind(address: Address): abi_uniswap_v3_pool {
    return new abi_uniswap_v3_pool("abi_uniswap_v3_pool", address);
  }
  ...
  burn(
    ...
    tickUpper: i32,
    amount: BigInt
  ): abi_uniswap_v3_pool__burnResult {
    ...
    return new abi_uniswap_v3_pool__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_burn(
    ...
    tickUpper: i32,
    amount: BigInt
  ): ethereum.CallResult<abi_uniswap_v3_pool__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__burnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  collect(
  ...
  ): abi_uniswap_v3_pool__collectResult {
    let result = super.call(
      "collect",
    ...
    return new abi_uniswap_v3_pool__collectResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collect(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<abi_uniswap_v3_pool__collectResult> {
    let result = super.tryCall(
      "collect",
      "collect(address,int24,int24,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__collectResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): abi_uniswap_v3_pool__collectProtocolResult {
    let result = super.call(
      "collectProtocol",
    ...
    return new abi_uniswap_v3_pool__collectProtocolResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<abi_uniswap_v3_pool__collectProtocolResult> {
    let result = super.tryCall(
      "collectProtocol",
      "collectProtocol(address,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__collectProtocolResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  mint(
    ...
    amount: BigInt,
    data: Bytes
  ): abi_uniswap_v3_pool__mintResult {
    let result = super.call(
      "mint",
    ...
    return new abi_uniswap_v3_pool__mintResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_mint(
    ...
    amount: BigInt,
    data: Bytes
  ): ethereum.CallResult<abi_uniswap_v3_pool__mintResult> {
    let result = super.tryCall(
      "mint",
      "mint(address,int24,int24,uint128,bytes):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__mintResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  observations(index: BigInt): abi_uniswap_v3_pool__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new abi_uniswap_v3_pool__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_observations(
    index: BigInt
  ): ethereum.CallResult<abi_uniswap_v3_pool__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,int56,uint160,bool)",
      [ethereum.Value.fromUnsignedBigInt(index)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  observe(secondsAgos: Array<BigInt>): abi_uniswap_v3_pool__observeResult {
    let result = super.call(
      "observe",
    ...
    return new abi_uniswap_v3_pool__observeResult(
  ...
  try_observe(
  ...
  ): ethereum.CallResult<abi_uniswap_v3_pool__observeResult> {
    let result = super.tryCall(
      "observe",
      "observe(uint32[]):(int56[],uint160[])",
      [ethereum.Value.fromUnsignedBigIntArray(secondsAgos)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__observeResult(
  ...
  positions(key: Bytes): abi_uniswap_v3_pool__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new abi_uniswap_v3_pool__positionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_positions(
    key: Bytes
  ): ethereum.CallResult<abi_uniswap_v3_pool__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(bytes32):(uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromFixedBytes(key)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__positionsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  protocolFees(): abi_uniswap_v3_pool__protocolFeesResult {
    let result = super.call(
      "protocolFees",
    ...
    return new abi_uniswap_v3_pool__protocolFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_protocolFees(): ethereum.CallResult<
    abi_uniswap_v3_pool__protocolFeesResult
  > {
    let result = super.tryCall(
      "protocolFees",
      "protocolFees():(uint128,uint128)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__protocolFeesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  slot0(): abi_uniswap_v3_pool__slot0Result {
    let result = super.call(
      "slot0",
    ...
    return new abi_uniswap_v3_pool__slot0Result(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_slot0(): ethereum.CallResult<abi_uniswap_v3_pool__slot0Result> {
    let result = super.tryCall(
      "slot0",
      "slot0():(uint160,int24,uint16,uint16,uint16,uint8,bool)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__slot0Result(
        value[0].toBigInt(),
        value[1].toI32(),
        value[2].toI32(),
        value[3].toI32(),
  ...
  snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): abi_uniswap_v3_pool__snapshotCumulativesInsideResult {
    let result = super.call(
      "snapshotCumulativesInside",
    ...
    return new abi_uniswap_v3_pool__snapshotCumulativesInsideResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): ethereum.CallResult<abi_uniswap_v3_pool__snapshotCumulativesInsideResult> {
    let result = super.tryCall(
      "snapshotCumulativesInside",
      "snapshotCumulativesInside(int24,int24):(int56,uint160,uint32)",
      [ethereum.Value.fromI32(tickLower), ethereum.Value.fromI32(tickUpper)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__snapshotCumulativesInsideResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  swap(
    ...
    data: Bytes
  ): abi_uniswap_v3_pool__swapResult {
    let result = super.call(
      "swap",
    ...
    return new abi_uniswap_v3_pool__swapResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swap(
    ...
    sqrtPriceLimitX96: BigInt,
    data: Bytes
  ): ethereum.CallResult<abi_uniswap_v3_pool__swapResult> {
    let result = super.tryCall(
      "swap",
      "swap(address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__swapResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  ticks(tick: i32): abi_uniswap_v3_pool__ticksResult {
    let result = super.call(
      "ticks",
    ...
    return new abi_uniswap_v3_pool__ticksResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_ticks(tick: i32): ethereum.CallResult<abi_uniswap_v3_pool__ticksResult> {
    let result = super.tryCall(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256,int56,uint160,uint32,bool)",
      [ethereum.Value.fromI32(tick)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new abi_uniswap_v3_pool__ticksResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
