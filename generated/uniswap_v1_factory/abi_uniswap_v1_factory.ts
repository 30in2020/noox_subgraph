...
export class abi_uniswap_v1_factory extends ethereum.SmartContract {
  static bind(address: Address): abi_uniswap_v1_factory {
    return new abi_uniswap_v1_factory("abi_uniswap_v1_factory", address);
  }
