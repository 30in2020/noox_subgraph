...
export class abi_uniswap_v3_factory extends ethereum.SmartContract {
  static bind(address: Address): abi_uniswap_v3_factory {
    return new abi_uniswap_v3_factory("abi_uniswap_v3_factory", address);
  }
